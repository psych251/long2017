...
Per the original experiment, "Trimmed reaction times were analyzed using a 2 x 2 repeated-measures ANOVA, with con- gruency (congruent/incongruent) and task (bigger/smaller on the screen) as factors."
